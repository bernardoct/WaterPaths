...
3. Assuming the ROF tables have been generated, run WaterPaths with `mpirun -n 5 triangleSimulation -T 4 -t 2344 -r 64 -d /mnt/c/Users/Bernardo/CLionProjects/WaterPaths/ -s sample_solutions.csv -m 0 -b true -C -1`. Keep in mind that the number of MPI processes must be at least 3 but the minimum recommended is 5. Also keep in mind that each MPI process will try to create the number of threads specified with flag -T.
